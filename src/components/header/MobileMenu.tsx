        ...
        <nav className="nav-main mainmenu-nav mt--30">
            <ul className="mainmenu metismenu" id="mobile-menu-active">
                ...
                <li className={`has-droupdown ${openMenuIndex === 1 ? 'mm-active' : ''}`}>
                    <Link href="#" className="main" onClick={() => toggleMenu(1)}>Pages</Link>
                ...
                <li className={`has-droupdown ${openMenuIndex === 2 ? 'mm-active' : ''}`}>
                    <Link href="#" className="main" onClick={() => toggleMenu(2)}>Shop</Link>
                    <ul className={`submenu mm-collapse ${openMenuIndex === 2 ? 'mm-show' : ''}`}>

                        {/* Shop Layout */}
                        <li className="has-droupdown third-lvl">
                            <Link href="#" className="main" onClick={() => toggleThirdMenu('shopLayout')}>Shop Layout</Link>
                        ...
                        {/* Shop Details */}
                        <li className="has-droupdown third-lvl">
                            <Link href="#" className="main" onClick={() => toggleThirdMenu('shopDetails')}>Shop Details</Link>
                        ...
                        {/* Product Feature */}
                        <li className="has-droupdown third-lvl">
                            <Link href="#" className="main" onClick={() => toggleThirdMenu('productFeature')}>Product Feature</Link>
                        ...
                        {/* Shop Others */}
                        <li className="has-droupdown third-lvl">
                            <Link href="#" className="main" onClick={() => toggleThirdMenu('shopOthers')}>Shop Others</Link>
                ...
                <li className={`has-droupdown ${openMenuIndex === 3 ? 'mm-active' : ''}`}>
                    <Link href="#" className="main" onClick={() => toggleMenu(3)}>Blog</Link>
